...
{
	[Serializable]
	public class PersistentNessusPolicy : NessusPolicy, IEntity
	{
		public PersistentNessusPolicy ()
		{
		}
		
		public PersistentNessusPolicy (NessusPolicy policy)
		{
			this.Name = policy.Name;
			this.Owner = policy.Owner;
			this.RemotePolicyID = policy.RemotePolicyID;
			this.Visibility  = policy.Visibility;
		}
