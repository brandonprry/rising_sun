...
{
	[Serializable]
	public class PersistentOneSixtyOneResults : OneSixtyOneToolResults, IEntity
	{
		public PersistentOneSixtyOneResults ()
		{
		}
		...
		public virtual PersistentPort ParentPort { get; set; }
