...
{
	[Serializable]
	public class PersistentMetasploitModuleAction : MetasploitModuleAction
	{
		public PersistentMetasploitModuleAction ()
		{
		}
		
		public PersistentMetasploitModuleAction(MetasploitModuleAction action)
		{
